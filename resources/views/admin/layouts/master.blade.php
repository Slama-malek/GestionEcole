...
<head>
    ...
    <link href="{{asset('adm/vendors/fullcalendar/dist/fullcalendar.min.css')}}" rel="stylesheet" type="text/css" />

    <!-- Daterangepicker CSS -->
    <link href="{{asset('adm/vendors/daterangepicker/daterangepicker.css')}}" rel="stylesheet" type="text/css" />

	<!-- vector map CSS -->
    <link href="{{asset('adm/vendors/vectormap/jquery-jvectormap-2.0.3.css')}}" rel="stylesheet" type="text/css" />
	
	<link href="{{asset('adm/vendors/apexcharts/dist/apexcharts.css')}}" rel="stylesheet" type="text/css" />
	...
	<!-- Toastr CSS -->
    <link href="{{asset('adm/vendors/jquery-toast-plugin/dist/jquery.toast.min.css')}}" rel="stylesheet" type="text/css">
...
<body>
	...
	<script src="{{asset('adm/vendors/waypoints/lib/jquery.waypoints.min.js')}}"></script>
	<script src="{{asset('adm/vendors/jquery.counterup/jquery.counterup.min.js')}}"></script>
	
	<!-- Morris Charts JavaScript -->
    <script src="{{asset('adm/vendors/raphael/raphael.min.js')}}"></script>
    <script src="{{asset('adm/vendors/morris.js/morris.min.js')}}"></script>
	
	<!-- EChartJS JavaScript -->
    <script src="{{asset('adm/vendors/echarts/dist/echarts-en.min.js')}}"></script>
    
	<!-- Sparkline JavaScript -->
    <script src="{{asset('adm/vendors/jquery.sparkline/dist/jquery.sparkline.min.js')}}"></script>
	
	<!-- Vector Maps JavaScript -->
    <script src="{{asset('adm/vendors/vectormap/jquery-jvectormap-2.0.3.min.js')}}"></script>
    <script src="{{asset('adm/vendors/vectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
    <script src="{{asset('adm/dist/js/vectormap-data.js')}}"></script>


	<!-- Owl JavaScript -->
    <script src="{{asset('adm/vendors/owl.carousel/dist/owl.carousel.min.js')}}"></script>
	
	<!-- Toastr JS -->
    <script src="{{asset('adm/vendors/jquery-toast-plugin/dist/jquery.toast.min.js')}}"></script>
    
    <!-- Init JavaScript -->
    <script src="{{asset('adm/dist/js/init.js')}}"></script>
	<script src="{{asset('adm/dist/js/dashboard-data.js')}}"></script>
    
    <!-----------datatable--------------------->

    <script src="{{asset('adm/vendors/datatables.net/js/jquery.dataTables.min.js')}}"></script>
    <script src="{{asset('adm/vendors/datatables.net-bs4/js/dataTables.bootstrap4.min.js')}}"></script>
    <script src="{{asset('adm/vendors/datatables.net-dt/js/dataTables.dataTables.min.js')}}"></script>
    <script src="{{asset('adm/vendors/datatables.net-buttons/js/dataTables.buttons.min.js')}}"></script>
    <script src="{{asset('adm/vendors/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js')}}"></script>
    ...
    <script src="{{asset('adm/dist/js/dataTables-data.js')}}"></script>
...
<script src="{{asset('adm/dist/js/toggle-data.js')}}"></script>
 ...
 <script src="{{asset('adm/vendors/moment/min/moment.min.js')}}"></script>
    <script src="{{asset('adm/vendors/jquery-ui.min.js')}}"></script>
    <script src="{{asset('adm/vendors/fullcalendar/dist/fullcalendar.min.js')}}"></script>
    <script src="{{asset('adm/dist/js/fullcalendar-data.js')}}"></script>


    <!-- Daterangepicker JavaScript -->
    <script src="{{asset('adm/vendors/moment/min/moment.min.js')}}"></script>
    <script src="{{asset('adm/vendors/daterangepicker/daterangepicker.js')}}"></script>
    <script src="{{asset('adm/dist/js/daterangepicker-data.js')}}"></script>
...
<script src="{{asset('adm/dist/js/init.js')}}"></script>
 ...
 <!-- Gallery JavaScript -->
 <!---
 <script src="{{asset('adm/vendors/lightgallery/dist/js/lightgallery-all.min.js')}}"></script>
 <script src="{{asset('adm/dist/js/froogaloop2.min.js')}}"></script>
 <script src="{{asset('adm/dist/js/gallery-data.js')}}"></script>
--->
