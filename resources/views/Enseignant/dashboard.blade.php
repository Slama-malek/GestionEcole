            ...
            <div class="col-6-xxxl col-lg-3 col-sm-6 col-12">
                <div class="dashboard-summery-two">
                    ...
                    <div class="item-content">
                        <?php $cli=\DB::table('enseignant_classes')
                        
                        ->join('eleve_classes' , 'eleve_classes.groupe_id' ,'=','enseignant_classes.groupe_id'  )
                        ...
                        <div class="item-title">{{$cli}} Total Students</div>
                    </div>
                </div>
            </div>
            <div class="col-6-xxxl col-lg-3 col-sm-6 col-12">
                        ...
                        <table class="table display data-table text-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="{{url('/ens/eleves',[$item->id_c,$item->id_g,$item->id_m])}}"><i class="flaticon-classmates"></i> </a></td>
                                    <td><a href="{{url('/ens/presences',[$item->id_c,$item->id_g,$item->id_m])}}"><i  class="flaticon-checklist"></i></a></td>
                                    <td><a href="{{url('/ens/notes',[$item->id_c,$item->id_g,$item->id_m])}}"><i class="flaticon-shopping-list"></i> </a></td>
