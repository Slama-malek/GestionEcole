        ...
        <div class="card">
            <div class="card-body">
                <div class="heading-layout1">
                    ...
                    <div class="item-title">
                        <h3>Feuille de présence de la classe  <code>{{$eleve->nom_c}}</code>, groupe : </strong> <code>{{$eleve->nom_g}}</code>, avril 2019
                        </h3>
                    </div>
                   <div class="dropdown">
                        <a class="dropdown-toggle" href="#" role="button" 
         ...
         ->where('presences.eleve_id','=',$item->id)
         
        ->select('presences.status','presences.date')
