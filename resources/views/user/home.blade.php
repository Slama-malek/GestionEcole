...
@section('content')
     ...
     <section class="main-slider style-one">
        ...
        @foreach ($sm1 as $sm)
            <div class="slide" style="background-image:url({{asset('uploads/images/'.$sm->name)}})">
                <div class="container">
    ...
    <section class="feature-section">
        ...
        <div class="image-column" style="background-image: url({{asset('cli/images/background/feature-bg.jpg')}});"></div>
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                    ...
                    <div class="teachers-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <div class="image-holder">
                                <figure class="image-box"><a href="#"><img src="{{asset('cli/images/resource/teacher-1.png')}}" alt=""></a></figure>
                            </div>
                            <div class="lower-content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 block-column">
                    <div class="teachers-block-one wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <div class="image-holder">
                                <figure class="image-box"><a href="#"><img src="{{asset('cli/images/resource/teacher-2.png')}}" alt=""></a></figure>
                            </div>
                            <div class="lower-content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 block-column">
                    <div class="teachers-block-one wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <div class="image-holder">
                                <figure class="image-box"><a href="#"><img src="{{asset('cli/images/resource/teacher-3.png')}}" alt=""></a></figure>
                            </div>
                            <div class="lower-content">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-12 col-md-12 event-block">
                    <div class="event-block-one wow fadeInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="event-details.html"><img src="{{asset('cli/images/resource/event-2.jpg')}}" alt=""></a></figure>
                            <div class="content-box">
                ...
                <div class="col-xl-6 col-lg-12 col-md-12 event-block">
                    <div class="event-block-one wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="event-details.html"><img src="{{asset('cli/images/resource/event-3.jpg')}}" alt=""></a></figure>
                            <div class="content-box">
                ...
                <div class="col-xl-6 col-lg-12 col-md-12 event-block">
                    <div class="event-block-one wow fadeInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="event-details.html"><img src="{{asset('cli/images/resource/event-4.jpg')}}" alt=""></a></figure>
                            <div class="content-box">
                            ...
                            <div class="client-thumb-outer">
                                <div class="client-thumbs-carousel owl-carousel owl-theme">
                                    <div class="thumb-item">
                                        <figure class="thumb-box"><img src="{{asset('cli/images/resource/testimonial-1.png')}}" alt=""></figure>
                                    </div>
                                    <div class="thumb-item">
                                        <figure class="thumb-box"><img src="{{asset('cli/images/resource/testimonial-2.png')}}" alt=""></figure>
                                    </div>
                                    <div class="thumb-item">
                                        <figure class="thumb-box"><img src="{{asset('cli/images/resource/testimonial-3.png')}}" alt=""></figure>
                                    </div>
                                    <div class="thumb-item">
                                        <figure class="thumb-box"><img src="{{asset('cli/images/resource/testimonial-1.png')}}" alt=""></figure>
                                    </div>
        ...
        <div class="container-fluid">
            ...
            <div class="gallery-carousel owl-carousel owl-theme">
                <div class="gallery-block">
                    <div class="image-box">
                        <figure class="image"><img src="{{asset('cli/images/gallery/1.jpg')}}" alt=""></figure>
                        <div class="overlay-box"><a href="{{asset('cli/images/gallery/1.jpg')}}" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-add"></i></a></div>
                    </div>
                </div>
                <div class="gallery-block">
                    <div class="image-box">
                        <figure class="image"><img src="{{asset('cli/images/gallery/2.jpg')}}" alt=""></figure>
                        <div class="overlay-box"><a href="{{asset('cli/images/gallery/2.jpg')}}" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-add"></i></a></div>
                    </div>
                </div>
                <div class="gallery-block">
                    <div class="image-box">
                        <figure class="image"><img src="{{asset('cli/images/gallery/3.jpg')}}" alt=""></figure>
                        <div class="overlay-box"><a href="{{asset('cli/images/gallery/3.jpg')}}" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-add"></i></a></div>
                    </div>
                </div>
                <div class="gallery-block">
                    <div class="image-box">
                        <figure class="image"><img src="{{asset('cli/images/gallery/4.jpg')}}" alt=""></figure>
                        <div class="overlay-box"><a href="{{asset('cli/images/gallery/4.jpg')}}" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-add"></i></a></div>
                    </div>
                </div>
                <div class="gallery-block">
                    <div class="image-box">
                        <figure class="image"><img src="{{asset('cli/images/gallery/5.jpg')}}" alt=""></figure>
                        <div class="overlay-box"><a href="{{asset('cli/images/gallery/5.jpg')}}" class="lightbox-image" data-fancybox="gallery"><i class="flaticon-add"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.html"><img src="{{asset('cli/images/resource/news-1.jpg')}}" alt=""></a></figure>
                            <div class="lower-content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.html"><img src="{{asset('cli/images/resource/news-2.jpg')}}" alt=""></a></figure>
                            <div class="lower-content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.html"><img src="{{asset('cli/images/resource/news-3.jpg')}}" alt=""></a></figure>
                            <div class="lower-content">
