...
<div class="container mt-xl-50 mt-sm-30 mt-15">
    ...
    <div class="hk-pg-header">
        ...
        <div class="d-flex">
            ...
            <a href="{{url('/parent/note/'.$eleve->id)}}"> <button type="button" class="btn btn-outline-light active">Notes</button></a>
                    </div>
        </div>
        </div>
    </div>
    ...
    <div class="hk-pg-wrapper">
        ...
        <div class="container">
            ...
            <!-- Title -->
            <div class="hk-pg-header">
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="alert-circle"></i></span></span>Notes</h4>
            </div>
            <!-- /Title -->
