...
<head>
	...
	<!-- Morris Charts CSS -->
    <link href="{{asset('adm/vendors/morris.js/morris.css')}}" rel="stylesheet" type="text/css" />
	...
	<!-- Data Table CSS -->
    <link href="{{asset('adm/vendors/datatables.net-dt/css/jquery.dataTables.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('adm/vendors/datatables.net-responsive-dt/css/responsive.dataTables.min.css')}}" rel="stylesheet" type="text/css" />
...
<body>
	...
	<div class="hk-wrapper hk-alt-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar hk-navbar-alt">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapseAlt">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="{{url('/dashboard-parents')}}" >Accueil</a>
                    </li>
                    <li class="nav-item dropdown show-on-hover">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            ->count('par_id')
                            ?>
                            Eleves <span class="badge badge-primary badge-sm badge-pill ml-10">{{$cli}}</span>
							</a>
        ...
        ->get();
                        ...
                        <a class="dropdown-item" href="{{url('/parent/eleve/'.$eleve->id)}}">{{$eleve->nom}}    <code style="color:#AF56AB">{{$eleve->nom_c}}</code> </a>
@endforeach
                             </div>
                    </li>
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar">
                                    <img src={{asset('adm/images/child.png')}}  style="background-color:#233c46 ;width:120% ;height:120%" alt="user" class="avatar-img rounded-circle">
                                </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                        ...
                        <div class="dropdown-divider" ></div>
                        <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();  document.getElementById('logout-form').submit();"><i class="dropdown-icon zmdi zmdi-power"></i><span>Log out</span></a>
	...
	<!-- Easy pie chart JS -->
    <script src="{{asset('adm/vendors/easy-pie-chart/dist/jquery.easypiechart.min.js')}}"></script>
	...
	<!-- Peity JavaScript -->
    <script src="{{asset('adm/vendors/peity/jquery.peity.min.js')}}"></script>
   
    <!-- Init JavaScript -->
    <script src="{{asset('adm/dist/js/init.js')}}"></script>
    <script src="{{asset('adm/dist/js/dashboard3-data.js')}}"></script>
